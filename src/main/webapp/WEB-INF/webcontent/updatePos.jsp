...
<body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td class="main_locbg font2">当前位置：职位管理 &gt; 修改职位</td>
			...
			<td>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="10"
					...
					<tr>
						<td class="font3 fftd">
							<table>
								<form action="/staffhome/position/updatePos" method="post">
									<tr>
										...
										<td class="font3 fftd">薪资：<input required="required"
											type="text" name="money" id="money" size="20"
											value="${money}" /></td>
										<input type="hidden" name="id" id="id" value="${id}" size="20" />
									</tr>
									<tr>
