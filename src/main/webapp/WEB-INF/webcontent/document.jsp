						...
						<c:forEach items="${list}" var="item">
							<tr id="data_0" align="center" class="main_trbg"
								...
								<td align="center" width="130px;"
									...
									href="updateDoc_pre?id=${item.id}&title=${item.title}&filename=${item.filename}&remark=${item.remark}&create_date=${item.create_date}&user_id=${item.user_id}"
									style='text-decoration: none;'>修改</a>&nbsp;<a href="deleteDoc?id=${item.id}&filename=${item.filename}" style='text-decoration: none;'>删除</a></td>
								<td align="center" width="130px;"
									style="background-color: rgb(220, 220, 220);"><a
