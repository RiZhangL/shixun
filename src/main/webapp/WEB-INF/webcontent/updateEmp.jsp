						...
						<td class="font3 fftd">
							<table>
								<tr>
									...
									<form action="/staffhome/employee/updateEmp" method="post">
										
										<tr>
											<td class="font3 fftd">姓名：<input required="required"
										type="text" name="name" id="name" size="20" value="${name}"/></td>
										</tr>
										<tr>
											<td class="font3 fftd">性别：<input required="required" type="text"
											name="gender" id="gender" size="20" value="${gender}"/></td>
										</tr>
										<tr>
											<td class="font3 fftd">生日：<input required="required" type="text"
											name="birthday" id="birthday" size="20" value="${birthday}"/></td>
										</tr>
										<tr>
											<td class="font3 fftd">地址：<input required="required" type="text"
											name="address" id="address" size="20" value="${address}"/></td>
										</tr>
										<tr>
											<td class="font3 fftd">电话：<input required="required" type="text"
											name="phone" id="phone" size="20" value="${phone}"/></td>
										</tr>
										<tr>
											<td class="font3 fftd">部门：<input required="required" type="text"
											name="department" id="department" size="20" value="${department}"/></td>
										</tr>
										<tr>
											<td class="font3 fftd">职位：<input required="required" type="text"
											name="position" id="position" size="20" value="${position}"/></td>
										</tr>
										<tr>
											<td class="font3 fftd">状态：<input required="required" type="text"
											name="state" id="state" size="20" value="${state}"/></td>
										</tr>
										<tr>
											<td class="font3 fftd">创建日期：<input required="required" type="text"
											name="creation_time" id="creation_time" size="20" value="${creation_time}"/></td>
										</tr>
