...
<body>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td class="main_locbg font2">当前位置：部门管理 &gt; 部门查询</td>
						...
						<c:forEach items="${list}" var="item">
							<tr id="data_0" align="center" class="main_trbg"
								...
								<td align="center" width="130px;"
									...
									href="transmission?name=${item.name}&info=${item.info}&manager_id=${item.manager_id}&item=${item.id}"
									style='text-decoration: none;'>修改</a>&nbsp;<a
									href="deleteDep?id=${item.id}" style='text-decoration: none;'>删除</a></td>
