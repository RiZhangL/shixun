...
<body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td class="main_locbg font2">&nbsp;&nbsp;&nbsp;&nbsp;当前位置：职位管理
				&gt; 添加职位</td>
						...
						<td class="font3 fftd">
							<table>
								<tr>
									...
									<form action="/staffhome/position/addPos" method="post">
										<td class="font3 fftd">职位名称：<input required="required"
											type="text" name="name" id="name" size="20" /></td>
										<td class="font3 fftd">详细描述：<input required="required"
											type="text" name="info" id="info" size="20" /></td>
										<td class="font3 fftd">薪资：<input required="required"
											type="text" name="money" id="money" size="20" /></td>
										<tr>
