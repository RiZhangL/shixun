			...
			<div class="menuList">
				<ul class="menu1">
					...
					<li class="menuli1"><a class="menua1"
						...
						<ul class="menu2">
							<li class="menuli2"><a class="menua2"
								href="javascript:menu_ajax('tgls/agent/agent_list.html', '部门管理,部门查询')"><i
									class="menua2_ico"><span></span></i>部门查询</a></li>
							<li class="menuli2"><a class="menua2"
								href="javascript:menu_ajax('tgls/agent/agent_add.html', '部门管理,添加部门')"><i
					...
					<li class="menuli1"><a class="menua1"
						...
						<ul class="menu2">
							<li class="menuli2"><a class="menua2"
								href="javascript:menu_ajax('tgls/agent/agent_list.html', '职位管理,职位查询')"><i
									class="menua2_ico"><span></span></i>职位查询</a></li>
							<li class="menuli2"><a class="menua2"
								href="javascript:menu_ajax('tgls/agent/agent_add.html', '职位管理,添加职位')"><i
